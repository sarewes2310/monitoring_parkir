...
@section('content')
    <div class="container">
        <form method="POST" action="{{ route('simpan_tambah_pegawai') }}" enctype="multipart/form-data" class="was-validated">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="nip_nim">NIP</label>
                            <input type="text" class="form-control @error('nim_nip') is-invalid @enderror" id="nim_nip" name="nim_nip" placeholder="NIP dari pegawai" required>
                            @error('nim_nip')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_pengguna') is-invalid @enderror" id="nama_pengguna" name="nama_pengguna" placeholder="Nama dari pegawai" required>
                            @error('nama_pengguna')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <!-- INPUT UNIT / FAKULTAS-->
                    <div class="mb-3">
                        <label for="alamat">Unit atau Fakultas</label>
                        <textarea class="form-control @error('fakultas') is-invalid @enderror" id="fakultas" name="fakultas" placeholder="Nama Unit atau Fakultas" required></textarea>
                        @error('fakultas')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="foto">Pilih foto pegawai...</label>
                        @error('foto')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
