...
@section('content')
    <div class="container">
        <form method="POST" action="{{ route('simpan_tambah_operator') }}" class="was-validated">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Username dari operator" required>
                            @error('username')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nama dari operator" required>
                            @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('notelp') is-invalid @enderror" id="notelp" name="notelp" placeholder="Nomer Telephone dari operator" required>
                            @error('notelp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
